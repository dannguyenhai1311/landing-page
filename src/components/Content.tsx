            ...
            {Array(4)
              ...
              .map((items, index) => {
                return (
                  <div
                    key={index}
                    className="border border-[#CCCCCC] rounded-lg max-w-[360px] text-box bg-[##FFFFFF] hover:bg-primary hover:text-white"
                  >
                    ...
                    <p className="p-2 text-sm text-[##606A74]">
                      ...
                      바이며, 있는 못할 석가는 끓는 생의 찾아다녀도, 사막이다.
                      크고 두손을 원대하고, 인간의 봄바람이 ...
                    </p>
                    <span className="text-xs p-2 text-[##3B4650]">
                      2023-05-05
                    </span>
                  </div>
                );
